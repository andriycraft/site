...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="AndriyCraft">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <meta property="og:image" content="https://newcdn.andriycraft.page/newwebsitefiles/img/server-icon.png"/>
    ...
    <meta name="twitter:image" content="https://newcdn.andriycraft.page/newwebsitefiles/img/server-icon.png" />
    <title>AndriyCraft | Головна сторінка</title>
    <link href='https://newcdn.andriycraft.page/newwebsitefiles/img/server-icon.png' rel='apple-touch-icon' type='image/png'>
    <link href="https://newcdn.andriycraft.page/newwebsitefiles/img/server-icon.png" rel="icon">
...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar">
            <a class="navbar-link" href="#" onclick="v()">Голосувати </a>
        </nav>
    </header>
    <hr>
...
[17] Пофікшено баги з спавном золота на шахматні карті</p>
    ...
    <center>
    <div class="footer">
        <p><a href="https://andriycraft.page/?action=privacy">Privacy Policy</a> </p>
        <br>
        <br>
